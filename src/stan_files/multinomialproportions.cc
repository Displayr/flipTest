...
#include "multinomialproportions.hpp"

RCPP_MODULE(stan_fit4multinomialproportions_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_multinomialproportions")
