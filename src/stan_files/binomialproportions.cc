...
#include "binomialproportions.hpp"

RCPP_MODULE(stan_fit4binomialproportions_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_binomialproportions")
